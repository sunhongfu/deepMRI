...
################## End Section 2 ##########################
    ...
    def forward(self, x, z_prjs):
        ...
        x_h, x_l = self.MidConv1(x_h, x_l,z_prjs)
        ...
        for decodingLayer in temp:
            ...
            x_h, x_l = temp_conv(x_h, x_l, x_h2, x_l2, z_prjs)
            #print('DecodeConv' + str(decodingLayer) + str(x.size()))

        x = self.FinalOct(x_h, x_l, z_prjs)
        x = x + INPUT
        return x 
