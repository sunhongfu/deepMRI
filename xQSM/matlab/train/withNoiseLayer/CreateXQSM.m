...
info.numInputChannels = 16; % the default number of input channels
info.numOutputChannels = 16; % the default number of output channels
%% default encoding path: 2
encoding_depth = 3;  % adjusted for the training data (patch size 48^3);
