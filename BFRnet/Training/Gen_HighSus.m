...
% Name of inputs and outputs should contain folder paths and numeric prefixes.
% e.g., name_input1 = ['../../Input/tfs_'] (your folder)
%   or  name_input2 = ['../../Label/bkg_']

path_qsm = ['../../cosmos'];
path_bkg = ['../../bkg_field_fullbrain'];
...
path_QSM_HC_patch = ['../../qsm_HC_'];
path_tfs_patch = ['../../tfs_'];
path_mask_patch = ['../../mask_'];
